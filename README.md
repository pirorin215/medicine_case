...
│   ├── README.md               # ファームウェア説明・仕様
│   └── INTAKE_DETECTION_SPEC.md # 服薬判定ロジック仕様
│
└── MedicineCaseMob/            # スマートフォンアプリ (Android)
    └── INTAKE_NOTIFICATION_SPEC.md # 通知・履歴管理ロジック仕様
```
...
- [服薬判定ロジック仕様](medicine_case/INTAKE_DETECTION_SPEC.md)
- [データフロー・通信プロトコル仕様](medicine_case/DATA_FLOW_SPEC.md)
